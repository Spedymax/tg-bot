...
conn = psycopg2.connect(
    database="d7onbblv7h1j4i",
    user="u3psg5rd33v41r",
    host="ec2-63-34-142-108.eu-west-1.compute.amazonaws.com",
    password="p7c71c8e38f3263fb7a19db15d7859bf744268751399974714630cfda41547fa9",
    sslmode='require'
)
