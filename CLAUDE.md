...
- **Урон**: тривия (5), Wordle (8 + 2 за неиспользованную попытку), `/pisunchik` (3), комната данжа (2), мини-пуджик (12). Фазы: ≤66% — Джарвис захвачен на 24ч (инъекция в `_POST_PROMPT` moltbot), ≤33% — ярость (x2). День 7 — Торговец с загадкой (ответ в чат → x2 на 24ч).
