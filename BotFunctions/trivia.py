...
def get_question_from_gemini(category):
    try:
        ...
        ОБЪЯСНЕНИЕ: [короткое объяснение почему это правильный ответ]
        ...
        Вопросы и ответы не должны быть длинными.
        Ответы не должны быть слишком очевидными.
        Ответы не должны быть длинными
        Неправильные ответы должны быть правдоподобными.
        Каждый ответ должен быть не более 10 кб"""
